...
export const skills: Skill[] = [
  ...
  // { id: '9', name: 'Python', level: 10, category: 'backend', color: '#3776AB' },
  { id: '10', name: 'Django', level: 0, category: 'backend', color: '#092E20' },
  { id: '11', name: 'FastAPI', level: 0, category: 'backend', color: '#009688' },
  ...
  // Tools
  { id: '16', name: 'Docker', level: 10, category: 'tools', color: '#2496ED' },
  { id: '17', name: 'AWS', level: 0, category: 'tools', color: '#FF9900' },
...
export const experiences: Experience[] = [
  {
    id: '1',
    company: 'DALE',
    position: 'Consultor de Desarrollo Frame Banking',
    description: 'Soy parte del equipo de Desarrollo de Frame banking para DALE, realizando ajustes y mantenimiento',
    startDate: '2023-01',
    current: true,
    technologies: ['FrameBanking', "Mambu"],
    achievements: [
      'Mejoramos la relacion entre el prudcto Frame y el cliente',
      'Implementamos nuevos servicios',
      'Mentorias constantes a nuevos desarrolladores del equipo',
      'Manejé la migración de clientes'
    ]
  },
  // {
  //   id: '2',
...
export const socialLinks: SocialLink[] = [
  {
    name: 'GitHub',
    url: 'https://github.com/luchoca',
    icon: 'github',
    color: '#333'
  },
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/luchocastrosaad/',
    icon: 'linkedin',
    color: '#0077B5'
  },
  {
  ...
  {
    name: 'Email',
    url: 'mailto:lucianocastrosaad@gmail.com',
    icon: 'mail',
    color: '#EA4335'
  }
];
